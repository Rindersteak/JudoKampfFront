...
const classContent = () => {
  ...
  return (
    <div className='fightModeContainer'>
      ...
      <div
        className={`menuRulesAdults ${selectedMenu === 'menuRulesAdults' ? 'selected' : ''}`}
      ...
      <div
        className={`menuRulesTeenagers ${selectedMenu === 'menuRulesTeenagers' ? 'selected' : ''}`}
      ...
      <div
        className={`menuClasses ${selectedMenu === 'menuClasses' ? 'selected' : ''}`}
