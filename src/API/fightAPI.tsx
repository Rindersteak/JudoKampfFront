...
export async function getFightList(fightgroupId: number) { // Typ des Parameters hinzugefügt
  try {
    const response = await fetch(`${API_DOMAIN}/fightgroups/${fightgroupId}/fightlist`);
